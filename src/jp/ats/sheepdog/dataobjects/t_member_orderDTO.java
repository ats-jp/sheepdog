 ...
 */
public class t_member_orderDTO extends java.lang.Object implements DTO {
	 ...
	 * 登録用コンストラクタです。
	 */
	public t_member_orderDTO() {
		relationship = Relationship.getInstance(t_member_order.RESOURCE_LOCATOR);
	 ...
	 */
	public t_member_orderDTO(UpdatableDataObject data) {
		relationship = Relationship.getInstance(t_member_order.RESOURCE_LOCATOR);
		this.data = data;
	}
	 ...
	 * @param value 更新値
	 */
	public void setmember_order(java.lang.String value) {
		ValueExtractor valueExtractor = Selector.getValueExtractors()
			.selectValueExtractor(
				relationship.getColumn("member_order").getType());
		data.setValue("member_order", valueExtractor.extractAsBinder(value));
	}
	 ...
	 * @return 返却値
	 */
	public java.lang.String getmember_order() {
		Binder binder = data.getBinder("member_order");
		if (binder == null) return null;
	 ...
	 */
	public t_groupDTO gett_groupByt_member_order_group_id_fkey() {
		return new t_groupDTO(
			data.getDataObject(t_member_order.t_group_BY_t_member_order_group_id_fkey));
	}
	 ...
	 * @return 参照しているレコードの DTO
	 */
	public t_userDTO gett_userByt_member_order_owner_fkey() {
		return new t_userDTO(
			data.getDataObject(t_member_order.t_user_BY_t_member_order_owner_fkey));
	}
